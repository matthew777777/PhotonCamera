...
// Exact 2x expansion phase and weights used by darktable's binomial pyramid.
...
// darktable src/common/locallaplacian.c curve_scalar(), expressed in GLSL.
...
void main() {
    ...
    // darktable samples six reference luminances at (k + 0.5) / 6 and
    // interpolates the two neighboring remapped Laplacian coefficients.
