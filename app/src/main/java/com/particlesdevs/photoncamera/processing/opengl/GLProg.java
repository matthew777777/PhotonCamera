    ...
    public int compileShader(final int shaderType, final String shaderSource) {
        ...
        if (shaderHandle != 0) {
            ...
            if (compileStatus[0] == 0) {
                ...
                Log.e(TAG, "Error compiling shader: " + shaderInfoLog);
                glDeleteShader(shaderHandle);
                throw new RuntimeException("Error creating shader: " + shaderInfoLog + "\nProgram:" + shaderSource);
            }
        }
        if (shaderHandle == 0) {
            throw new RuntimeException("Error creating shader: glCreateShader returned 0. Program:" + shaderSource);
        }
        return shaderHandle;
    }
