...
public final class TunableRegistry {
    ...
    public static final Class<?>[] TUNABLE_CLASSES = {
        ...
        com.particlesdevs.photoncamera.processing.opengl.postpipeline.DemosaicRCD.class,
        com.particlesdevs.photoncamera.processing.opengl.postpipeline.ExperimentalCaptureSharpening.class,
        com.particlesdevs.photoncamera.processing.opengl.postpipeline.HighlightRecovery.class,
