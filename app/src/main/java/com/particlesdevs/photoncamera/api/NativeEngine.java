...
public class NativeEngine {
     ...
     */
    public static native Method nativeGetCameraMethod(Class<?> clazz, String methodName, Class<?>[] parameterTypes);
    
    /**
     * Native method to resolve camera metadata fields
     */
    public static native Field nativeGetCameraField(Class<?> clazz, String fieldName);

    /**
     * Prepare input for RawNIND inference by re-mapping Bayer data to 4-channel float array
     */
    public static native void nativePrepareRawNINDInput(
    ...
    /**
     * Apply RawNIND inference output back to the Bayer buffer with blending
     */
    public static native void nativeApplyRawNINDOutput(
            java.nio.ByteBuffer inputBuffer,
            java.nio.FloatBuffer accumulatedOutput,
            java.nio.FloatBuffer weightSum,
            int width,
            int height,
            int rawStride,
            float whiteLevel,
    ...
    /**
     * Efficiently copy and blend a tile result into the large output and weight buffers
     */
    public static native void nativeShuffleTileRes(
            float[] tileData,
            java.nio.FloatBuffer fullOutput,
            java.nio.FloatBuffer weightSum,
            int startX,
            int startY,
            int tileW,
